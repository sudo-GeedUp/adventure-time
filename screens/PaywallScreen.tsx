      ...
      >
        <View style={styles.heroSection}>
          ...
          <Text style={styles.heroSubtitle}>
            Get unlimited access to all features and take your off-road adventures to the next level
          </Text>
        </View>
        ...
        <View style={styles.footer}>
          <Text style={styles.footerText}>
            7-day free trial, then {selectedPlan === 'yearly' ? '$79.99/year' : '$9.99/month'}.{'\n'}
